...
var uni = [];
graduates.forEach( element => element.university.includes("Uni") ? uni.push(element.university):"");
console.log(uni);
...
populationTotal = zooAnimals.reduce((total, element) => element.population + total, 0)
